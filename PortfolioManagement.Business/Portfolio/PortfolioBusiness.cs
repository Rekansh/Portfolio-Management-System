...
namespace PortfolioManagement.Business.Portfolio
{
    ...
    /// </summary>
    public class PortfolioBusiness : CommonBusiness, IPortfolioRepository
    {
        ISql sql;
        ...
        /// </summary>
        public PortfolioBusiness(IConfiguration config) : base(config)
        {
        ...
        public async Task<PortfolioReportEntity> SelectPortfolioReport(StockTransactionParameterEntity transactionParameterEntity)
        {
            ...
            portfolioReportEntity.Scripts = await sql.ExecuteListAsync("Portfolio_Report", CommandType.StoredProcedure, mapPortfolioReportEntity);
